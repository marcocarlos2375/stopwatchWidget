<?php
namespace OCA\stopwatchwidget\Dashboard;

use OCA\stopwatchwidget\Service\GifService;
...
class VueWidget implements IAPIWidget {
	...
	public function getId(): string {
		return 'stopwatchwidget-vue-widget';
	}
	...
	public function getTitle(): string {
		return $this->l10n->t('stopwatchwidget ');
	}
